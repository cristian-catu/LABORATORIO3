...
void main(void) {
    ...
    if(PORTCbits.RC0 == 1){
        ...
        while(1){
            ...
            POT1_ENVIO = POT1 & 0b11111110;
            POT2_ENVIO = POT2 | 0b00000001;
        }
    }
}
